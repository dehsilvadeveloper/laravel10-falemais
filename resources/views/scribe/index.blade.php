...
<div class="tocify-wrapper">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-plans">GET api/plans</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-fares">
                                <a href="#endpoints-GETapi-fares">GET api/fares</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-call-prices-simulate">
                                <a href="#endpoints-POSTapi-call-prices-simulate">POST api/call-prices/simulate</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: April 8, 2024</li>
    </ul>
</div>
...
<div class="bash-example">
    ...
    --data "{
    \"email\": \"katelin38@example.org\",
    \"password\": \"%0&gt;(ZG}o5Hi2Yq[\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="katelin38@example.org"
               data-component="body">
    <br>
<p>Must be a valid email address. Must be at least 6 characters. Must not be greater than 70 characters. Example: <code>katelin38@example.org</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 6 characters. Example: <code>%0&gt;(ZG}o5Hi2Yq[</code></p>
        </div>
        </form>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-fares">GET api/fares</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-call-prices-simulate">POST api/call-prices/simulate</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 3 characters. Must not be greater than 3 characters. Example: <code>ykv</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 3 characters. Must not be greater than 3 characters. Example: <code>h</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
